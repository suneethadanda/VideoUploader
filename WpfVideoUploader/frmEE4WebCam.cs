...
namespace EE4Test
{
    public partial class frmEE4WebCam : Form
    {
        ...
        public frmEE4WebCam()
        {
            ...
            fileName = Common.RecordedVideos + "\\" + Guid.NewGuid() + ".wmv";

            timer = new Timer();
            timer.Tick += new EventHandler(timer_Tick);
            timer.Interval = 1000; //set interval on 1 second
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            formatedTime = string.Format("{0}:{1}:{2}",
                                    t.Hours,
                                    t.Minutes,
                                    t.Seconds);

            lblRecordingTime.Text = formatedTime;
        }
        ...
        private void startorstoprecording()
        {
            ...
            if (_bStartedRecording)
            {
                ...
                // Stops encoding
                _job.StopEncoding();
                ///_job.AddDeviceSource(null, null);
            ...
            else
            {
                ...
                if (video != null && audio != null)
                {
                    ...
                    else
                    {
                        ...
                        //        following instructions (called few lines belows): 'panelVideoPreview.Size=' and '_job.OutputFormat.VideoProfile.Size=' 
                        //        to be the one you choosed (640, 480).
                        _deviceSource.PickBestVideoFormat(new Size(640, 360), 15);
                    }
                ...
                fileTemp = Common.RecordedVideos + "\\" + Guid.NewGuid() + ".wmv";
                fileOut.OutputFileName = fileTemp;
