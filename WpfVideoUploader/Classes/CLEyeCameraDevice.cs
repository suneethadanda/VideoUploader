...
namespace CLEyeMulticam
{
    ...
    public class CLEyeCameraDevice : DependencyObject, IDisposable
    {
        ...
        [DllImport("CLEyeMulticam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool PS3EyeMulticamLoadSettings(String filename);

        [DllImport("CLEyeMulticam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool PS3EyeMulticamSaveSettings(String filename);

        [DllImport("CLEyeMulticam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void PS3EyeMulticamShowSettings();

        [DllImport("CLEyeMulticam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool PS3EyeMulticamGetFrameDimensions(ref int width, ref int height);

        [DllImport("CLEyeMulticam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool PS3EyeMulticamGetFrame(byte[] data, int waitTimeout);
        ...
        public CLEyeCameraDevice()
        {
            // set default values
            Framerate = 15;
            ColorMode = CLEyeCameraColorMode.CLEYE_COLOR_PROCESSED;// default(CLEyeCameraColorMode);
